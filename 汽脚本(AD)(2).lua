...
local ui =loadstring(game:HttpGet("https://raw.githubusercontent.com/soda-QISHUI/qishui4/refs/heads/main/%F0%9F%98%B1%F0%9F%98%B1%F0%9F%98%B1%F0%9F%98%B1.lua"))()

local win = ui:new("汽脚本")
--
local UITab1 = win:Tab("『本脚本完全免费不接受倒卖』",'123803512184010')
...
local UITab2 = win:Tab("『公告』",'123803512184010')

local about = UITab2:section("『公告』",true)

about:Label("感谢支持汽脚本")
about:Label("bug待修复")
about:Label("欢迎进群了解汽脚本")
about:Label("1009641699")
local UITab3 = win:Tab("『通用』",'123803512184010')
...
local UITab3 = win:Tab("音乐",'123803512184010')
...
local UITab1 = win:Tab("力量传奇有bug",'123803512184010')
...
about:Toggle("深蹲架传奇健身房", "text",false,function(rack)
    if game.Players.LocalPlayer.leaderstats.Strength.Value >= 6000 then
getgenv().spam = rack
while getgenv().spam do
wait()
if game.Players.LocalPlayer.machineInUse.Value == nil then
...
wait()
if game.Players.LocalPlayer.machineInUse.Value == nil then
    if game.Players.LocalPlayer.leaderstats.Strength.Value >= 8000 then
...
about:Toggle("卧推传奇健身房","text",false,function(rack)
    if game.Players.LocalPlayer.leaderstats.Strength.Value >= 12000 then
getgenv().spam = bench
while getgenv().spam do
wait()
if game.Players.LocalPlayer.machineInUse.Value == nil then
...
about:Toggle("卧推肌肉之王健身房","text",false,function(rack)
    if game.Players.LocalPlayer.leaderstats.Strength.Value >= 20000 then
getgenv().spam = bench
while getgenv().spam do
wait()
if game.Players.LocalPlayer.machineInUse.Value == nil then
...
local UITab2 = win:Tab("极速传奇",'123803512184010')
...
about:Button("传送到传奇公路",function()
 ...
 local UITab4 = win:Tab("doors",'123803512184010')

local about = UITab4:section("脚本A",true)
about:Button("非常好用",function()
...
local UITab5 = win:Tab("『Door2』",'123803512184010')
...
local about = UITab6:section("木材大亨2",true)
about:Button("齐静春推荐",function()
...
local UITab8 = win:Tab("最强战场",'123803512184010')
...
setclipboard("BestTheStrongest5412Roblox")
  ...
  local UITab9 = win:Tab("巴掌模拟器",'123803512184010')
...
about:Button("多功能（老外）",function()
 ...
 local UITab10 = win:Tab("内脏与黑火药",'123803512184010')
...
about:Button("内脏与黑火药",function()
 ...
 local UITab11 = win:Tab("自然灾害模拟器",'123803512184010')
...
about:Button(
  ...
  local UITab12 = win:Tab("旋转",'123803512184010')
...
local UITab13 = win:Tab("『其他脚本』",'123803512184010')
...
local UITab14 = win:Tab("『监狱人生』",'123803512184010')
...
local UITab15 = win:Tab("『鲨口求生』",'123803512184010')
...
local UITab16 = win:Tab("『超级大力士模拟器』",'123803512184010')
...
local UITab17 = win:Tab("『国王遗产』",'123803512184010')

local about = UITab17:section("『国王遗产』",true)
...
if sphere then sphere:Destroy()
 end）
 
 about:Button("AUTO",function()
...
about:Button("UnderGround",function()
loadstring(game:HttpGt("https://raw.githubusercontent.com/marcola1212/UnderGroundV3-Hub/main/Version0.03"),true))0 
end）